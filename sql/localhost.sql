...
--
-- Host: localhost
-- Generation Time: Feb 05, 2026 at 06:27 PM
...
INSERT INTO `contacts` (`contactID`, `firstName`, `lastName`, `emailAddress`, `phoneNumber`, `status`, `dob`, `imageName`) VALUES
(1, 'Dion', 'Gusija', 'diongusija12@gmail.,com', '5195208061', 'member', '1999-08-20', NULL),
(2, 'Ardi', 'Gjemajli', 'Ardigjemajli@gmail.com', '555-111-8052', 'member', '2000-01-09', NULL),
(3, 'Blend', 'Gjemajli', 'Blendigjemajli@gmail.com', '5195225221', 'nonmember', '1993-02-21', NULL);
...
('root', '[{\"db\":\"contact_manager\",\"table\":\"contacts\"},{\"db\":\"mysql\",\"table\":\"tables_priv\"},{\"db\":\"mysql\",\"table\":\"table_stats\"},{\"db\":\"mysql\",\"table\":\"db\"}]');
...
('root', '2026-02-05 17:26:44', '{\"Console\\/Mode\":\"collapse\"}');
